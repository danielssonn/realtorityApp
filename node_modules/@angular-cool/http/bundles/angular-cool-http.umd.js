(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('tslib'), require('@angular/core'), require('@angular/common/http'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@angular-cool/http', ['exports', 'tslib', '@angular/core', '@angular/common/http', 'rxjs'], factory) :
    (factory((global['angular-cool'] = global['angular-cool'] || {}, global['angular-cool'].http = {}),global.tslib,global.ng.core,global.ng.common.http,null));
}(this, (function (exports,tslib,core,http,rxjs) { 'use strict';
    ...
    var CookieStore = /** @class */ (function () {
        ...
        CookieStore.prototype.getCookieCollection = function () {
            ...
            if (this.lastReadRawCookieCollection.indexOf('; ') !== -1) {
                ...
                try {
                    for (var cookies_1 = tslib.__values(cookies), cookies_1_1 = cookies_1.next(); !cookies_1_1.done; cookies_1_1 = cookies_1.next()) {
     ...
     * @suppress {checkTypes} checked by tsc
     */
    var /** @type {?} */ DEFAULT_REQUEST_OPTIONS = {};
    var CoolHttp = /** @class */ (function () {
        ...
        CoolHttp.prototype._requestCoreObservable = function (url, method, data, options, action) {
            return rxjs.from(this._requestCoreAsync(url, method, data, options, action));
        };
        /**
         * @param {?} url
         * @return {?}
        ...
        CoolHttp.prototype._modifyOptions = function (options) {
            var /** @type {?} */ resultOptions = {
                headers: options.headers || new http.HttpHeaders(),
                observe: 'response',
        ...
        CoolHttp.prototype._appendGlobalHeaders = function (headers) {
            ...
            try {
                for (var _b = tslib.__values(this._globalHeaders), _c = _b.next(); !_c.done; _c = _b.next()) {
        ...
        CoolHttp.prototype._tryAppendRegisteredCookiesToCustomHeaders = function (headers) {
            ...
            var /** @type {?} */ newHeaders = headers;
            try {
                for (var _b = tslib.__values(this._customCookieToHeaders), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                return tslib.__generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            ...
                            _b = tslib.__values(this._requestInterceptors), _c = _b.next();
                            _d.label = 1;
                        case 1:
                            if (!!_c.done)
                                return [3 /*break*/, 4];
            ...
            return tslib.__awaiter(this, void 0, void 0, function () {
                ...
                return tslib.__generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            _d.trys.push([0, 5, 6, 7]);
                            _b = tslib.__values(this._responseInterceptors), _c = _b.next();
                            _d.label = 1;
                        case 1:
                            if (!!_c.done)
                                return [3 /*break*/, 4];
        ...
        CoolHttp.prototype._updateAngularHeadersFromHttpClientHeaders = function (httpClientHeaders, headers) {
            ...
            var /** @type {?} */ newHeaders = headers;
            try {
                for (var httpClientHeaders_1 = tslib.__values(httpClientHeaders), httpClientHeaders_1_1 = httpClientHeaders_1.next(); !httpClientHeaders_1_1.done; httpClientHeaders_1_1 = httpClientHeaders_1.next()) {
                ...
                try {
                    if (httpClientHeaders_1_1 && !httpClientHeaders_1_1.done && (_a = httpClientHeaders_1.return))
                        _a.call(httpClientHeaders_1);
                }
                finally {
                    if (e_5)
                        throw e_5.error;
    ...
    /** @nocollapse */
    CoolHttp.ctorParameters = function () {
        return [
     ...
     * @suppress {checkTypes} checked by tsc
     */
    var CoolHttpModule = /** @class */ (function () {
         ...
         * @return {?}
         */
        CoolHttpModule.forRoot = function () {
            return {
...
//# sourceMappingURL=angular-cool-http.umd.js.map
